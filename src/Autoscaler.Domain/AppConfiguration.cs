...
public class AppConfiguration
{
    ...
    {
        var maxRunners = configuration.GetValue("MaxRunners", 4);
        ...
        return new AppConfiguration()
        {
            ...
            IsRepoWhitelistExactMatch = configuration.GetValue("IsRepoWhitelistExactMatch", true),
            ...
            AutoCheckForImageUpdates = configuration.GetValue("AutoCheckForImageUpdates", true)
        };
    }
}